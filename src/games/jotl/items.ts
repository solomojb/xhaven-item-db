...
export const items: GloomhavenItem[] = [
	...
	},
	{
		...
		source: "Reward from Scenario #2",
		desc: "During your turn gain Shield ^shield^ 1 for the rest of the round",
		spent: true,
		folder: "1-13",
		unlockScenario: 2,
		gameType: GameType.JawsOfTheLion,
	...
	},
	{
		...
		source: "Reward from Scenario #2",
		spent: true,
		desc: "During your movement add +1 Move ^move^ to a single movement.",
		folder: "1-13",
		unlockScenario: 2,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #2",
		spent: true,
		desc: "During your movement, add Jump ^jump^ to the entire Move Action.",
	...
	},
	{
		...
		slot: GloomhavenItemSlot.OneHand,
		source: "Reward from Scenario #2",
		desc: "During your ranged attack, add STUN $stun$ to a single attack",
		consumed: true,
		folder: "1-13",
		unlockScenario: 2,
		gameType: GameType.JawsOfTheLion,
	...
	},
	{
		...
		spent: true,
		desc: "During your turn, \"Heal ^heal^ 1, Self\" action.",
		folder: "15-20",
		unlockScenario: 9,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #9",
		spent: true,
		desc: "During your ranged attack, add CURSE $curse$ to a single attack.",
		folder: "15-20",
		unlockScenario: 9,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #15",
		spent: true,
		desc: "When damaged by an attack, gain Shield ^shield^ 2 for the attack and the attacker suffers 2 damage.",
		folder: "21-26",
		unlockScenario: 15,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #15",
		spent: true,
		desc: "During your movement, add +2 Move ^move^ to a single movement.",
		folder: "21-26",
		unlockScenario: 15,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #15",
		spent: true,
		desc: "During your ranged attack, add PULL $pull$ 2 to a single attack.",
		folder: "21-26",
		unlockScenario: 15,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		source: "Reward from Scenario #15",
		consumed: true,
		desc: "During your turn, perform a \"BLESS $bless$, Range ^range^ 5\" action.",
		folder: "21-26",
		unlockScenario: 15,
		gameType: GameType.JawsOfTheLion,
		imgFileNumber: 1,
	...
	},
	{
		...
		cost: 40,
		slot: GloomhavenItemSlot.OneHand,
		source: "Reward from Scenario #23",
		consumed: true,
